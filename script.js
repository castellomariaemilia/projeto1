    ...
    $.ajax({
        ...
        success: function (data) {           
            ...
            for (let i = 0; i < filter.length; i++) {               
                ...
                htmlFilter1 += '<input id="option-' + cont +'" type="checkbox" name="' + filter[i] + '" value="' + filter[i] + '" class="em-c-input-group__control" checked>'
            ...
            for (let i = 0; i < filter2.length; i++) {               
                ...
                htmlFilter2 += '<input id="option-' + cont +'" type="checkbox" name="' + filter2[i] + '" value="' + filter2[i] + '" class="em-c-input-group__control" checked>'
